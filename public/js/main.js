...
lahetaLomake2(event,i,likeNum,kirjautunut,json);});
...
lahetaLomake3(event,i,dislikeNum,kirjautunut,json);});
...
//tykkaa
const lahetaLomake2 = (evt,kuvaId,likeNum,kirjautunut,json) => {
evt.preventDefault();
...
//dislike
const lahetaLomake3 = (evt,kuvaId,dislikeNum,kirjautunut,json) => {
evt.preventDefault();
const fd = {};
fd.kuvaId = kuvaId;
fd.kirjautunut = kirjautunut;
